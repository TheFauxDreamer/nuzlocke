// Pokemon names for autocomplete functionality across generations 1-7
// This is a boilerplate - add specific Pokemon names as needed

const pokemonNamesByGeneration = {
    ...
    // Generation 2 - Johto (100 new Pokemon)
    gen2: [
    ...
    // Generation 3 - Hoenn (135 new Pokemon)
    gen3: [
    ...
    // Generation 4 - Sinnoh (107 new Pokemon)
    gen4: [
    ...
    // Generation 5 - Unova (156 new Pokemon)
    gen5: [
    ...
    // Generation 6 - Kalos (72 new Pokemon)
    gen6: [
        ...
        'Gourgeist', 'Bergmite', 'Avalugg', 'Noibat', 'Noivern',
        'Xerneas', 'Yveltal', 'Zygarde', 'Diancie', 'Hoopa', 'Volcanion'
    ],

    // Generation 7 - Alola (88 new Pokemon including Alolan forms)
    gen7: [
        // Starters and Early Route Pokémon
        ...
        // Oricorio Forms
        'Oricorio', // Has 4 forms: Baile, Pom-Pom, Pa'u, Sensu
...
// For backwards compatibility and autocomplete
let pokemonNames = [];

// This will be populated based on the selected generation
